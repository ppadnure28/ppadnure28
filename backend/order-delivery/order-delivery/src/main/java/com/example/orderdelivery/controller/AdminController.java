...
import com.example.orderdelivery.dto.OrderResponseDTO;
...
public class AdminController {
    ...
    public ResponseEntity<List<OrderResponseDTO>> getAllOrders(
        ...
        List<OrderResponseDTO> orders = orderService.listOrdersDTO();
        ...
        if (status != null && !status.isEmpty()) {
            try {
                ...
                orders = List.of(); // invalid status = empty result
            }
        }
    ...
    public ResponseEntity<List<String>> getOrderTimeline(@PathVariable Long id) {
        ...
        List<String> timeline = List.of("PLACED", "ACCEPTED", "PREPARING", "PICKED_UP", "DELIVERED", "REJECTED");
